...
HD_PWD='C:/ATU/VS files/PD/Adder2Bit/Adder2Bit.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder2Bit.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Adder2Bit.tcl -notrace
