...
HD_PWD='C:/ATU/VS files/PD/Adder2Bit/Adder2Bit.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Adder2Bit.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Adder2Bit.tcl
